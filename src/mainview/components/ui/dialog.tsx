...
>(({ className, children, ...props }, ref) => (
	<DialogPortal>
		...
		<DialogPrimitive.Content
			ref={ref}
			className={cn(
				// [&>*]:min-w-0 (not upstream shadcn): grid items default to
				// min-width:auto, so a nowrap line anywhere inside (e.g. a
				// `truncate` file name) would inflate children past max-w-lg
