...
/**
 * The app's preferences — the equalizer, the Discord presence — and at the
 * bottom the way off the machine. It stands in its own section rather than in a
 * dialog because settings are a place to be, not an interruption, and like
 * Discover it declares no aside (see `components/Sections`), so its column is
		...
		<div className="flex h-full flex-col">
			...
			<ScrollArea className="min-h-0 flex-1">
				...
				<div className="mx-auto flex max-w-2xl flex-col gap-5 p-5">
					<EqualizerPanel />
					<DiscordPanel />
					{/* Last: sets nothing, and there is no way back from it. */}
					<UninstallPanel />
				</div>
			</ScrollArea>
		</div>
